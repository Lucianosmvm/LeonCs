const MISSION_14 = {
  ...
  steps: [
    ...
    // Q4 — MC
    {
      ...
      opts: [
        {t:'Argumentos', ok:false},{t:'Variáveis globais', ok:false},
        {t:'Retornos', ok:false},{t:'Parâmetros', ok:true},
      ],
    ...
    // Q14 — Code
    {
      ...
      hint:'3² + 4²',
      opts: [
        {t:'7', ok:false},{t:'49', ok:false},
        {t:'12', ok:false},{t:'25', ok:true},
      ],
    ...
    // Q17 — Code
    {
      ...
      hint:'5 × 4 × 3 × 2 × 1',
      opts: [
        {t:'60', ok:false},{t:'15', ok:false},
        {t:'25', ok:false},{t:'120', ok:true},
      ],
